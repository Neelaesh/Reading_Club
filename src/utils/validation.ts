 ...
 * @description Validates member form data comprehensively including email format
 * validation, required field checks, and business rule validation.
 * @param formData - The member form data to validate
 ...
 * @description Utility function to check if a string contains only whitespace characters.
 * Determines whether a string is empty or contains only spaces, tabs,
 * newlines, or other whitespace characters for form validation.
